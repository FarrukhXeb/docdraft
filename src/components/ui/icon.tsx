...
/**
 * Lucide glyph geometry, copied verbatim from the design system's
 * assets/icons/*.svg (2px stroke, 24px grid). Add a glyph by copying its SVG
 * inner markup from the Lucide repo and extending this map.
 */
export const ICON_PATHS: Record<string, string> = {
  ...
  "library-big":
    '<rect width="8" height="18" x="3" y="3" rx="1"></rect><path d="M7 3v18"></path><path d="M20.4 18.9c.2.5-.1 1.1-.6 1.3l-1.9.7c-.5.2-1.1-.1-1.3-.6L11.1 5.1c-.2-.5.1-1.1.6-1.3l1.9-.7c.5-.2 1.1.1 1.3.6Z"></path>',
...
export interface IconProps extends React.SVGAttributes<SVGSVGElement> {
  /** Icon name, e.g. "sparkles", "file-text". Must exist in ICON_PATHS. */
  name: string;
  /** px or any CSS length. Default 16. */
  size?: number | string;
